...
os.chdir(r"C:\Users\sajjaphnrj_j\Documents\Membrane")
...
for P in PLoad:
	...
	mdb.models['Model-1'].ShellEdgeLoad(name='Edge Load', 
		createStepName='Load Application', region=region, magnitude=P, 
	...
	# Extracting Results
	o3 = session.openOdb(
		name='C:/Users/sajjaphnrj_j/Documents/Membrane/MembraneAnalysis.odb')
	...
	session.viewports['Viewport: 1'].setValues(
		displayedObject=session.odbs['C:/Users/sajjaphnrj_j/Documents/Membrane/MembraneAnalysis.odb'])
	session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=OFF, bcs=OFF, 
		predefinedFields=OFF, connectors=OFF)
		
	# Save Deflection	
	odb = session.odbs['C:/Users/sajjaphnrj_j/Documents/Membrane/MembraneAnalysis.odb']
	session.writeFieldReport(fileName='abaqusMembrane'+str(P)+'.txt', append=OFF, 
	...
	session.printToFile(fileName='DeformedMembrane'+str(P)+'tif', format=TIFF, canvasObjects=(
