...
os.chdir(r"N:\Project\ABAQUS\Results\SingleCrease\Tri Mesh")
...
for M in MS:
	...
	# Meshing
	mdb.models['Model-1'].parts['Part-1'].setMeshControls(regions=mdb.models['Model-1'].parts['Part-1'].faces.getSequenceFromMask(mask=('[#1 ]', ), ), elemShape=TRI)
	...
	# Extracting Results
	o3 = session.openOdb(
		name='N:\Project\ABAQUS\Results\SingleCrease\Tri Mesh\MembraneAnalysis.odb')
	...
	session.viewports['Viewport: 1'].setValues(
		displayedObject=session.odbs['N:\Project\ABAQUS\Results\SingleCrease\Tri Mesh\MembraneAnalysis.odb'])
	session.viewports['Viewport: 1'].assemblyDisplay.setValues(loads=OFF, bcs=OFF, 
		predefinedFields=OFF, connectors=OFF)
		
	# Save Deflection	
	odb = session.odbs['N:\Project\ABAQUS\Results\SingleCrease\Tri Mesh\MembraneAnalysis.odb']
