...
os.chdir(r"C:\Users\sajjaphnrj_j\Documents\Project\Beam")

PLoad = np.arange(1e-5,0.00101,1e-5)
...
for P in PLoad:
	...
	o3 = session.openOdb(
		name='C:\Users\sajjaphnrj_j\Documents\Project\Beam\PlainAnalysis.odb')
	...
	session.viewports['Viewport: 1'].setValues(
		displayedObject=session.odbs['C:\Users\sajjaphnrj_j\Documents\Project\Beam\PlainAnalysis.odb'])
	...
	session.printToFile(fileName='Deformed Beam'+str(P), format=TIFF, canvasObjects=(
		session.viewports['Viewport: 1'], ))
	
	# Save Y-Deflection
	odb = session.odbs['C:\Users\sajjaphnrj_j\Documents\Project\Beam\PlainAnalysis.odb']
	session.writeFieldReport(fileName='abaqus'+str(P)+'.txt', append=OFF, 
